...
call s:hi('Conditional' , 68  , '' , 'None' , 'None')
...
call s:hi('Exception'  , 204 , ''  , 'None' , 'None')
...
call s:hi('Directory' , 67 , '' , 'None' , 'None')
call s:hi('Repeat'    , 68 , '' , 'None' , 'None')
call s:hi('Keyword'   , 68 , '' , 'None' , 'None')
call s:hi('Statement' , 68 , '' , 'None' , 'None')
call s:hi('Structure' , 68 , '' , 'None' , 'None')
...
call s:hi('pythonClass'           , 207 , '' , 'none' , 'none')
...
call s:hi('pythonBuiltinObj'      , 71  , '' , 'none' , 'none')
call s:hi('pythonBuiltinFunc'     , 169 , '' , 'none' , 'none')
call s:hi('pythonOperator'        , 68  , '' , 'none' , 'none')
call s:hi('pythonInclude'         , 68  , '' , 'none' , 'none')
call s:hi('pythonSelf'            , 68  , '' , 'none' , 'none')
call s:hi('pythonStatement'       , 68  , '' , 'none' , 'none')
call s:hi('pythonDottedName'      , 169 , '' , 'none' , 'none')
call s:hi('pythonDecorator'       , 169 , '' , 'none' , 'none')
call s:hi('pythonException'       , 166 , '' , 'none' , 'none')
